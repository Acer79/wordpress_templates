 ...
 * @return array
 */
function adonepagecmb_sample_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes[] = array(
		'title' => 'adonepagecmb Test - all fields',
		'pages' => 'post',
		'fields' => $fields
	);
	...
	$meta_boxes[] = array(
		'title' => 'adonepagecmb Test - group (all fields)',
		'pages' => 'post',
		'fields' => array(
			array( 
				'id' => 'gp', 
...
add_filter( 'adonepagecmb_meta_boxes', 'adonepagecmb_sample_metaboxes' );
