	...
	function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
		...
		if ( class_exists( 'RevSlider' ) ) {
			$wbc_sliders_array = array(
				'01_Despero' => array(
					'revslider/home-classic.zip',
                    'revslider/blog-classic.zip',
                    'revslider/reservation.zip',
                    'revslider/menu.zip',
                    'revslider/contact.zip',
                    'revslider/about.zip',
                    'revslider/gallery.zip',
                    'revslider/team.zip',
                    'revslider/home-reservation.zip',
                    'revslider/home-event.zip',
                    'revslider/clients-say.zip',
                    'revslider/home-dark.zip',
				),
			);
		...
		//	Setting Menus (If it's demo1 - demo6)
		...
		//	Set HomePage (array of demos/homepages to check/select from)
